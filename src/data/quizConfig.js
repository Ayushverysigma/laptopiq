...
export const USE_TO_TAG = {
  ...
  "CAD (3D Modeling)": "cad",
  "3D Rendering": "cad",
  "Excel/Data Crunching": "daily",
  Presentations: "daily",
  "Notes & Research": "daily",
  "Digital Art": "editing",
  Research: "daily",
  Notes: "daily",
  "Light Daily Tasks": "daily",
  "Daily Tasks": "daily",
};
...
export const QUIZ_FLOW = {
  ...
  gpuPref: {
    ...
    multi: false,
    options: [
      "Yes, absolutely (Heavy gaming/CAD)",
      "No, I prioritize battery life",
      "Not sure",
    ],
    next: () => "os",
  },
  ...
  portability: {
    ...
    options: [
      "Very (Ultra-light)",
      "Moderate (Standard)",
      "Not at all (Desktop replacement)",
    ],
    next: () => "battery",
  },
  battery: {
  ...
  os: {
    ...
    next: (ans) => (ans["os"] === "macOS" ? null : "brand"),
  },
  brand: {
    id: "brand",
    ...
    multi: false,
    options: (ans) =>
      ans["os"] === "Windows" ? BRANDS.filter((b) => b !== "Apple") : BRANDS,
